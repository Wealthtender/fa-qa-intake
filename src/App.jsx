        ...
        {phase === "welcome" && (
          <div className="wt-card" style={{ animation: "fadeUp .5s ease both" }}>
            ...
            <div className="wt-actions">
              <p style={{ fontFamily: "'Hanken Grotesk', system-ui, sans-serif", fontSize: "13px", lineHeight: 1.55, color: "#3a4750", margin: "0 0 14px" }}>
  By continuing, you confirm your responses will reflect your own professional experience and knowledge and your authentic views, not substantive answers generated by AI. You also agree to the{" "}
  <a href="https://wealthtender.com/wealthtender-large-employer-qa-participation-agreement/" target="_blank" rel="noopener noreferrer" style={{ color: "#1a5276", fontWeight: 600 }}>Large Employer Q&A participation agreement</a>
  , which includes one-year terms, automatic renewal, and the edit and cancellation terms described there. Please contact{" "}
  <a href="mailto:yourfriends@wealthtender.com" style={{ color: "#1a5276", fontWeight: 600 }}>yourfriends@wealthtender.com</a>{" "}
  with questions.
</p>
